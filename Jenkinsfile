pipeline {
    ...
    stages {
        stage('Git Checkout') {
            steps {
                git branch: 'dev-be', changelog: false, credentialsId: '70ef5427-1490-4d73-b7ad-fd77bb21a57c', poll: false, url: 'https://github.com/Khusheel26/Nike-Store-using-TailWind.git'
            }
        }
